...
def model_opts(parser):
    ...
    group.add('--dec_rnn_size', '-dec_rnn_size', type=int, default=500,
              help="Size of decoder rnn hidden states. "
                   ...
                   "speech-to-text.")
    group.add('--enc_layer_norm', '-enc_layer_norm', action="store_true",
              help="Layer normalization of input and hidden states for encoder"
              "(only implemented for rnn)")
    group.add('--dec_layer_norm', '-dec_layer_norm', action="store_true",
              help="Layer normalization of input and hidden states for decoder"
              "(only implemented for rnn)")
